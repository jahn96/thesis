...
def mine_data(nlp, neuralcoref, data, srl=None):
    ...
    return noun_mod_occurrences, named_entities_dist, verb_obj_occurrences, subj_verb_occurrences
...
if __name__ == '__main__':
    ...
    noun_mod_occurrences, named_entities_dist, verb_obj_occurrences, subj_verb_occurrences = mine_data(nlp, neuralcoref, cnn_dm_ds)
